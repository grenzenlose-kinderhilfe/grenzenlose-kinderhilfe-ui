    ...
    >
      <GridItem align="center" p="25px">
        ...
        >
          ...
          <Text fontStyle="italic">{localization.headingSub}</Text>
          <Text fontStyle="italic">{localization.stepMakeBox}</Text>
          <Text fontStyle="italic">{localization.stepDonate}</Text>
          <Text fontStyle="italic">{localization.stepHappy}</Text>
        </Flex>
      </GridItem>
      <GridItem
        display="flex"

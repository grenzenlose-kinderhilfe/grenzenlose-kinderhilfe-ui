...
const Media = () => {
  ...
  const localization = {
    rollingKidsParadeBeregszaszHeading: t(
      "pages.media.rollingKidsParadeBeregszaszHeading",
      "Rolling Kids felvonulás Beregszászon",
    ),
    rollingKidsParadeBeregszaszContent: t(
      "pages.media.rollingKidsParadeBeregszaszContent",
      "A Határtalan Segítség Alapítvány és a P. Frangepán Katalin Gimnázium szervezésében, a Beregszászi Polgármesteri Hivatal és a városi oktatási osztály, valamint a Kossuth Lajos Líceum közreműködésével a Vérke-parti város ovisai és alsó tagozatos iskolásai közlekedésbiztonsági és környezetvédelmi programon vettek részt Rolling Kids elnevezéssel.",
    ),
    ratChildrenHomeBicycleHeading: t(
      "pages.media.ratChildrenHomeBicycleHeading",
      "Kerékpárokat kaptak a Ráti Gyermekotthon csemetéi a Határtalan Segítség Alapítványtól",
    ),
    ratChildrenHomeBicycleContent: t(
      "pages.media.ratChildrenHomeBicycleContent",
      "Adománnyal teli kisbusz érkezik a Ráti Szent Mihály Gyermekotthon udvarára. Az anyaországi Határtalan Segítség Alapítvány ezúttal 10 darab kerékpárral lepte meg az intézmény lurkóit, amelyet holland partnereik segítségével gyűjtöttek.",
    ),
